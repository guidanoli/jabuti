...
public class DirectoryPreferenceType implements PreferenceType {
	...
	protected JButton btn = new JButton(GlobalStrings.gui_popup_preferences_type_dir_panel_btnlabel);
	...
	protected String openDialog(String defaultDir) {
		...
		jfc.setDialogTitle(GlobalStrings.gui_popup_preferences_type_dir_dlg_title);
		jfc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		int returnValue = jfc.showDialog(null,GlobalStrings.gui_popup_preferences_type_dir_dlg_btnlabel);

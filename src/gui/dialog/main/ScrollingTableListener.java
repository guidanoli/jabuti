...
/**
 * Borrowed from <a href="https://stackoverflow.com/a/14390562/5696107">
 * this post</a>
 * @author AngerClown
 *
 */
public final class ScrollingTableListener implements ComponentListener {
	  private final JTable table;

	  public ScrollingTableListener(JTable table, JScrollPane scrollPane) {
	    assert table != null;
